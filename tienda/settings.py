...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'elbenjacarrasco35@gmail.com'  # Reemplaza con tu dirección de correo Gmail
EMAIL_HOST_PASSWORD = 'mvwxmgsjouopnxwe' # Reemplaza con tu contraseña de "aplicación generada"
